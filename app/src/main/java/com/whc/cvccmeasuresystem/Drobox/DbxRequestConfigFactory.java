package com.whc.cvccmeasuresystem.Drobox;
...
public class DbxRequestConfigFactory {
    ...
    public static List<String> scope= Arrays.asList("account_info.read", "files.content.write","files.content.read","contacts.write");
